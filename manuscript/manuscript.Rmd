...
In the last decade, there has been a proliferation in the use of high resolution (HR) MS instrumentation with Orbitrap mass analysers becoming the standard for HRMS.
...
Similarly, the alignment of spectra between samples can also make processing difficult over long analytical runs containing many samples [@draper2013].
...
This was a result of the measured deviation in *m/z* peaks both between each scan of a sample and between samples.
...
The accuracy of some of the extracted accurate m/z peaks from the chemical standards mix are shown in Table \@ref(tab:accurate-masses).
